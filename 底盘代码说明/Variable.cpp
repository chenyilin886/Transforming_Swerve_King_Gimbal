...
Steer_Data_t Steer_Data = {
    ...
    // 更新日期：2026-07-21
    .offset = {169.151001f, 350.826416f, 266.973267f, 104.051514f},
...
Kinematics_Params_t Kinematics_Params = {
    ...
    .Phase = {0.0299999993f, 0.0f, -0.0599999987f, 0.0f},  // 相位补偿（2026-07-21 标定）
    .SpeedGain = 2.0f,      // 速度增益系数
    .RotationalGain = 2.0f  // 旋转增益系数
};
...
Remote_Params_t Remote_Params = {
    ...
    // ===== 底盘跟随参数【新增】=====
    .follow_kp = 3.0f,       // 跟随角度P控制增益（推荐初始值）
                             // 调参方法：Watch中从1.0开始，逐步增加
    .follow_ki = 0.0f,       // 跟随角度I控制增益（暂时为0）
    .follow_kd = 0.0f,       // 跟随角度D控制增益（暂时为0）
    .max_vw_follow = 6.0f    // 跟随模式最大旋转速度限制（约360°/s）
};
...
// ===== 板间通信调试数据 =====
// 初始化为默认值，上电后由 BoardComm 更新
// Watch 中可观察 BoardComm_Data 的所有字段
BoardCommDebug_t BoardComm_Data = {
    // ===== 接收数据（云台→底盘）=====
    .LX = 110,                   // 右摇杆X中值
    .LY = 110,                   // 右摇杆Y中值
